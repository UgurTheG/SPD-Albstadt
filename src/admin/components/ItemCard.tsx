...
export default function ItemCard({fields, item, index, total, onUpdate, onRemove, onMove}: Props) {
    ...
    return (
        <div
            className="bg-white/60 dark:bg-gray-900/40 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/40 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-black/20 hover:border-gray-300/60 dark:hover:border-gray-600/50 group/card">
            {/* Header */}
